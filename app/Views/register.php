...
<head>
    ...
    <title>Gorontalo Weather App - Register</title>
            ...
            <div class="p-8">
                ...
                <form action="<?= base_url('register'); ?>" method="post" class="space-y-6">
                    ...
                    <div class="text-center">
                        <p class="text-sm text-gray-600">Already have an account? <a href="<?= base_url('login'); ?>" class="text-blue-500 hover:underline">Sign In here</a></p>
                    </div>
                </form>
            </div>
        </div>
